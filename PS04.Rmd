...
So, in both cases, we see that how we split data into training and test sets is an important process. Overfitting is less of an issue if the training set is greater than the test set as we in the second graph that the RMSE for both sets do not diverge in trajectory. I guess this is why we usually go for a 70:30 split ratio.
